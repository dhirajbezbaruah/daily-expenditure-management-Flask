...
<meta content='jobs in assam, jobs in northeast, jobs in india, engineering job, 2019 batch, government job, apdcl job, apdcl admt card, hslc result, exam news, interview questions, apsc, ssc, assamcareer.info, assamcareer, assamcareer info, northeastcareer, northeastcareer info' name='keywords'/></b:if>
...
<b:if cond='data:blog.pageType == &quot;error_page&quot;'>
<style type='text/css'>
#viennalite-wrapper,#nav,.viennalitetop-wrapper {display:none;}
#footer-wrapper,#header-wrapper{visibility:hidden;opacity:0;width:0;height:0}
.error-container{background-image: url(http://1.bp.blogspot.com/-zHS2luoiNTM/VTZJiQmK7RI/AAAAAAAAJxw/D1Kiy-euLXM/s1600/blog-bg.jpg);background-size:cover;}
#footer-wrapper {background-color:transparent;margin:auto;margin-top:-60px;padding:20px;}
#copyright{color:#dcdbe2;}
#copyright a{color:#ed522e;}
#copyright a:hover{color:#dcdbe2;}
.error-header{margin-top:-100px}
.error-title{line-height:42px}
.error-title span{background:#d44929;padding:2px 10px;}
...
.error-title{color:#fff;font-family:&#39;Open Sans&#39;,sans-serif;font-size:42px;font-weight:700;text-transform:uppercase;margin:.67em 0;text-align:center;line-height:normal;}
.search-title{font-size:48px;color:#3f3f46}
.page-content,.page-content p{color:#797979;font-size:18px;text-align:center}
a.btn.back-to-home{background:#4fafe9;color:#fff;font-weight:400;left:40px;line-height:24px;padding:10px 30px;position:absolute;text-transform:capitalize;top:40px;z-index:99;border-radius:4px}
a.back-to-home:hover{background:#459dd3;color:#fff;}
a.back-to-home i{font-size:14px;margin-right:3px}
...
<div class='viennalitetop-wrapper'>
  ...
  <div class='vitop-wrapper'>
          <nav class='top-menulite'>
            <ul>
              <li><a href='https://www.facebook.com/groups/2275398966018421/' title='Join Our Official Facebook Group'><i class='fa fa-check-circle-o'/> Join Our Official Facebook Group</a></li>
<li class='doremifa join'><a href='https://www.blogger.com/follow-blog.g?blogID=5659233859857601011' rel='nofollow' target='_blank' title='Join Our Site'><i class='fa fa-plus'/><span class='inv'/></a></li>
...
<div class='header-wrapp'>
  <b:section class='header section' id='header' maxwidgets='1' showaddelement='no'>
    <b:widget id='Header1' locked='true' title='NorthEastCareer (Header)' type='Header' version='1'>
      <b:widget-settings>
        <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-USjLC0Ehisw/XGMCzJRNEkI/AAAAAAAAAEE/3Z91NlC1cegT8zivtBhOrvXeIXJiO-BRACK4BGAYYCw/s1600/logo.png.jpg</b:widget-setting>
        <b:widget-setting name='displayHeight'>92</b:widget-setting>
        <b:widget-setting name='sectionWidth'>239</b:widget-setting>
...
<li><a href='https://www.northeastcareer.info/search/label/Assam?max-results=10' itemprop='url'><span itemprop='name'>Jobs in Assam</span></a>
</li>
<li><a href='https://www.northeastcareer.info/search/label/india?max-results=10' itemprop='url'><span itemprop='name'>Jobs in india</span></a></li>
<li><a href='https://www.northeastcareer.info/search/label/engineering?max-results=10' itemprop='url'><span itemprop='name'>Engineering Jobs</span></a></li>
<li><a href='https://www.northeastcareer.info/search/label/govt?max-results=10' itemprop='url'><span itemprop='name'>Govt. jobs</span></a></li>
<li><a href='https://www.northeastcareer.info/search/label/exam?max-results=10' itemprop='url'><span itemprop='name'>Exam news</span></a></li>
<li><a href='https://www.northeastcareer.info/search/label/interview?max-results=10' itemprop='url'><span itemprop='name'>Interview Questions</span></a></li>
<li><a href='https://www.northeastcareer.info/search/label/other?max-results=10' itemprop='url'><span itemprop='name'>Other</span></a></li>
</ul>
  ...
  <span expr:class='&quot;item-control &quot; + data:backlink.adminClass'>
    <a expr:href='data:backlink.deleteUrl' expr:title='data:top.deleteBacklinkMsg'>
      ...
      <b:else/>
        ...
        <div class='breadcrumbs'><span itemscope='' itemtype='http://data-vocabulary.org/Breadcrumb'><a expr:href='data:blog.homepageUrl' itemprop='url'><span itemprop='title'><data:title/></span></a></span>  <b:loop values='data:post.labels' var='label'><span itemscope='' itemtype='http://data-vocabulary.org/Breadcrumb'><a expr:href='data:label.url + &quot;?&amp;amp;max-results=6&quot;' itemprop='url'><span itemprop='title'><data:label.name/></span></a></span><b:if cond='data:label.isLast != &quot;true&quot;'>  </b:if> </b:loop>  <span><data:post.title/></span>
        </div>
        <b:else/>
...
<a class='click-comment' expr:title='data:commentLabelPlural' href='#comment-form'><data:commentLabelPlural/></a>
  </b:if>
...
<div class='comment_author_flag'><i class='fa fa-check-circle'/></div>
</div>
...
<!-- Kode Banner/Iklan Anda Di sini -->
            ...
            <div style='clear: both;'/> 
				...
				<h3>Related Posts :</h3>
				<b:loop values='data:post.labels' var='label'> <b:if cond='data:label.isLast != &quot;true&quot;'/> <b:if cond='data:blog.pageType == &quot;item&quot;'> <script expr:src='&quot;/feeds/posts/default/-/&quot; + data:label.name + &quot;?alt=json-in-script&amp;callback=related_results_labels&amp;amp;max-results=6&quot;' type='text/javascript'/></b:if> </b:loop> <script type='text/javascript'> removeRelatedDuplicates(); printRelatedLabels(); </script>
				</div>
          </div>
        </div>
        <b:if cond='data:blog.pageType == &quot;static_page&quot;'>
...
<script src='https://cdn.rawgit.com/Arlina-Design/FlamingTree/master/paginavi.js'/>
        <div class='clear'/>
    </div>
	</b:includable>
...
<a expr:href='data:post.url'><div class='img-thumbnail'><script type='text/javascript'>
   document.write(arlina_thumbnail_resize(&quot;<data:post.thumbnailUrl/>&quot;,&#39;<data:post.title/>&#39;));
</script>
</div>
</a>
<b:else/>
...
<b:if cond='data:top.showAuthor'>
        ...
        <b:if cond='data:post.url'>
		  <span class='time-info'>
          <i class='fa fa-calendar-o'/> <a class='timestamp-link' expr:href='data:post.url' rel='bookmark' title='permanent link'><abbr class='published updated' expr:title='data:post.timestampISO8601'><data:post.timestamp/></abbr></a>
		  </span>
        </b:if>
        </b:if>
<b:if cond='data:blog.pageType == &quot;item&quot;'>
...
<span class='label-info'> 
<b:loop values='data:post.labels' var='label'>
<a expr:href='data:label.url + &quot;?max-results=10&quot;' rel='tag'><i class='fa fa-tag'/>&amp;nbsp;&amp;nbsp;<data:label.name/></a><b:if cond='data:label.isLast != &quot;true&quot;'/>
</b:loop>
</span>
</b:if>
</b:if>
...
<div class='pagenext-kiri'>
  <i class='fa fa-chevron-left arrowle'/>
...
<div class='pagenext-kanan'>
  <i class='fa fa-chevron-right arrowri'/>
...
<div style='clear: both;'/>
  ...
  <b:if cond='data:top.showEmailButton'><a class='goog-inline-block share-button sb-email' expr:href='data:post.share-postUrl + &quot;&amp;target=email&quot;' expr:title='data:top.emailThisMsg' target='_blank'><span class='share-button-link-text'><data:top.emailThisMsg/></span></a></b:if><b:if cond='data:top.showBlogThisButton'><a class='goog-inline-block share-button sb-blog' expr:href='data:post.share-postUrl + &quot;&amp;target=blog&quot;' expr:onclick='&quot;window.open(this.href, \&quot;_blank\&quot;, \&quot;height=270,width=475\&quot;); return false;&quot;' expr:title='data:top.blogThisMsg' target='_blank'><span class='share-button-link-text'><data:top.blogThisMsg/></span></a></b:if><b:if cond='data:top.showTwitterButton'><a class='goog-inline-block share-button sb-twitter' expr:href='data:post.share-postUrl + &quot;&amp;target=twitter&quot;' expr:title='data:top.shareToTwitterMsg' target='_blank'><span class='share-button-link-text'><data:top.shareToTwitterMsg/></span></a></b:if><b:if cond='data:top.showFacebookButton'><a class='goog-inline-block share-button sb-facebook' expr:href='data:post.share-postUrl + &quot;&amp;target=facebook&quot;' expr:onclick='&quot;window.open(this.href, \&quot;_blank\&quot;, \&quot;height=430,width=640\&quot;); return false;&quot;' expr:title='data:top.shareToFacebookMsg' target='_blank'><span class='share-button-link-text'><data:top.shareToFacebookMsg/></span></a></b:if><b:if cond='data:top.showOrkutButton'><a class='goog-inline-block share-button sb-orkut' expr:href='data:post.share-postUrl + &quot;&amp;target=orkut&quot;' expr:title='data:top.shareToOrkutMsg' target='_blank'><span class='share-button-link-text'><data:top.shareToOrkutMsg/></span></a></b:if><b:if cond='data:top.showDummy'><div class='goog-inline-block dummy-container'><data:post.dummyTag/></div></b:if>
</b:includable>
...
<div class='sidebar-inner'>
  <b:section class='sidebar-two section' id='sidebar-two' preferred='yes'>
  ...
  <div class='widget-content'>
    ...
    <b:widget id='HTML3' locked='false' title='Join official fb group' type='HTML'>
      <b:widget-settings>
        <b:widget-setting name='content'><![CDATA[<table border="0" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;"><tr style=""><td height="28" style="line-height:28px;">&nbsp;</td></tr><tr><td style=""><table border="0" width="280" cellspacing="0" cellpadding="0" style="border-collapse:separate;background-color:#ffffff;border:1px solid #dddfe2;border-radius:3px;font-family:Helvetica, Arial, sans-serif;margin:0px auto;"><tr style="padding-bottom: 8px;"><td style=""><img class="img" src="https://scontent-bom1-2.xx.fbcdn.net/v/t1.0-9/c0.0.464.242a/51910938_105977953878139_706871099169701888_n.jpg?_nc_cat=106&amp;_nc_ht=scontent-bom1-2.xx&amp;oh=072d7236a6e951d31901864bf4f8b449&amp;oe=5CEF6D19" width="280" height="146" alt="" /></td></tr><tr><td style="font-size:14px;font-weight:bold;padding:8px 8px 0px 8px;text-align:center;">Assam Job Notification</td></tr><tr><td style="color:#90949c;font-size:12px;font-weight:normal;text-align:center;">Closed group · 3 members</td></tr><tr><td style="padding:8px 12px 12px 12px;"><table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse;width:100%;"><tr><td style="background-color:#4267b2;border-radius:3px;text-align:center;"><a style="color:#3b5998;text-decoration:none;cursor:pointer;width:100%;" href="https://www.facebook.com/plugins/group/join/popup/?group_id=2275398966018421&amp;source=email_campaign_plugin" target="_blank" rel="noopener"><table border="0" cellspacing="0" cellpadding="3" align="center" style="border-collapse:collapse;"><tr><td style="border-bottom:3px solid #4267b2;border-top:3px solid #4267b2;color:#FFF;font-family:Helvetica, Arial, sans-serif;font-size:12px;font-weight:bold;">Join Group</td></tr></table></a></td></tr></table></td></tr><tr><td style="border-top:1px solid #dddfe2;font-size:12px;padding:8px 12px;">Join this group to get latest updates on job in Assam</td></tr></table></td></tr><tr style=""><td height="28" style="line-height:28px;">&nbsp;</td></tr></table>]]></b:widget-setting>
      </b:widget-settings>
      <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
  ...
  <b:include name='quickedit'/>
    ...
    <b:widget id='FollowByEmail1' locked='false' title='Never miss an update. Subscribe now!' type='FollowByEmail'>
      <b:includable id='main'>
  ...
  <span class='item-control blog-admin'>
    ...
    <b:widget id='PopularPosts2' locked='false' title='Popular Jobs' type='PopularPosts' version='1'>
      <b:widget-settings>
...
&lt;script type=&quot;text/javascript&quot; src=&quot;//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5c5c38df8f50ea22&quot;&gt;&lt;/script&gt;</b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
Created by <a href='#' id='virightcredit' rel='nofollow' style='visibility: Hidden' target='_blank'>Arlina Design</a>
</div> | Distributed By <a href='#' rel='dofollow' target='_blank'>Gooyaabi Templates</a>
</div>
</div>
  </div>
</footer>
